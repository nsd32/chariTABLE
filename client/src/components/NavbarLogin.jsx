                ...
                <div className="header-right">
                  <div className="dropdown open pull-xs-right">
                    ...
                    <div className="dropdown-menu dropdown-menu-right" aria-labelledby="lr1">
                      <a href="javascript:void(0)" className="btn btn-raised btn-primary no-focus" data-toggle="modal" data-target="#ms-account-modal" style={{margin: "10px"}} onClick={this.props.onClick}>Login</a>
                    </div>
                  </div>
                </div>
              </div>
